...
export const OdoMeterContent = [
  {
    name:"Trusted By",
    count : "200",
    sign:"Clients",
    label : "Building lasting partnership through reliable IT Services."
  },
  {
    name:"CLients With",
    count : "98",
    sign:"Satisfaction",
    label : "Delivering IT solution that boost productivity."
  },
  {
    name:"Deployed",
    count : "500",
    sign:"IT Infrastructure",
    label : "Delivered robust IT systems for businesses worldwide"
  },
...
export const Info = [
  {
    name: "Email US",
    desp:"Fast and Reliable Support",
    icon: <MdOutlineAlternateEmail />,
    value: "Abc@gmail.com",
  },
  {
  ...
  {
    name: "Our Address",
    desp:"Come visit us in our office",
